...
// ===== فقط در صورتی که دقیقاً یک تیم زنده باشد =====
if (count($teams_array) == 1) {
    $winner = $teams_array[0];
    $htmlOutput = '
    <div class="win-alert-container">
        <p class="win-alert-title">🏆 WINNER! 🏆</p>
        <p class="win-alert-name">' . esc_html($winner['name']) . '</p>
        <p class="win-alert-sub">CHICKEN DINNER!</p>
    </div>
    ';
}
